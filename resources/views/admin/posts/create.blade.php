                    ...
                    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="file" name="image" id="image"
                                class="block w-full text-sm text-gray-900 bg-gray-50 border border-gray-300 cursor-pointer">
                            @error('image')
                                <p class="mt-2 text-sm text-red-600 ">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            <label for="published_at" class="block mb-2 text-sm font-medium">Tanggal Publikasi (Kosongkan untuk draft)</label>
                        ...
                        <div class="mb-6">
                            ...
                            <div
                                class="grid grid-cols-2 md:grid-cols-3 gap-4 p-4 border border-gray-200 rounded-lg">
