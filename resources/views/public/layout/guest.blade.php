...
<body class="bg-gray-100 font-sans">
    <header class="relative overflow-hidden bg-black min-h-[200px] md:min-h-[300px]">
        <div class="absolute inset-0">
            <img src="{{ asset('storage/gambar/header.png') }}" alt="gambar header" class="h-full w-full object-cover object-right">
        </div>
    ...
    <footer class="bg-gray-800 text-white mt-12">
        <div class="container mx-auto px-6 py-8 text-center">
            <p>&copy; {{ date('Y') }} SDGs Portal. All Rights Reserved.</p>
        </div>
    </footer>
